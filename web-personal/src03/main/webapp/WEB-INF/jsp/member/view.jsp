...
<c:if test="${not empty member}">
        ...
        <div class='form-group row'>
        <label for='password' class='col-sm-2 col-form-label'>암호 변경</label>
        <div class='col-sm-10'>
        ...
        <input type="checkbox" class="custom-control-input" id="cancelFlag" name="cancelFlag" value="1" ${member.cancelFlag == '1' ? 'checked' :''}>
