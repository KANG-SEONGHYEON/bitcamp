...
// 가능한 업무 용어를 사용한다.
//
public interface GreenGrapeService {
    
    int add(GreenGrape greenGrape);
    GreenGrape get(int no);
    List<GreenGrape> list(int no,int pageNo, int PageSize, Map<String,Object> options);
    int sum(int no);
    int getTotalCount();
