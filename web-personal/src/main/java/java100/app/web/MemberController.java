...
public class MemberController {
    ...
    public String add(
            ...
            MultipartFile memberPhoto) throws Exception {
        ...
        if (!memberPhoto.isEmpty()) {
            ...
            String filename = this.writeUploadFile(memberPhoto, uploadDir);
    ...
    private String writeUploadFile(MultipartFile photo, String path) throws IOException {
        
        String filename = getNewFilename(photo.getOriginalFilename());
