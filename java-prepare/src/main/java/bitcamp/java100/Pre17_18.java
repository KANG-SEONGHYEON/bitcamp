...
public class Pre17_18 {
	...
	static class My {
		...
		/* 클래스 메서드
		 * - 클래스에 소속된 메서드
		 * - static이 붙은 메서드이다. 그래서 "static 메서드"라고도 부른다.
	...
	public static void main(String[] args) {
		 ...
		 * 해당 메서드가 클래스 메서드임을 명확히 하는게 소스 코드를 해석하기 쉽게한다.
		 * 이클립스에서도 클래스 메서드를 레퍼런스 변수로 호출하면 위와 같이 경고 메시지를 띄운다.
		 */
