 ...
 * 바이너리 파일
 * - 메모장과 같은 텍스트 편집기로 유효한 편집을 할 수 없는 파일
 * - 전용 편집기가 필요하다.
 * - 예) .hwp, .doc, .xls, .ppt, .avi, .mp3, .exe, .class, psd 등
 * 
 * 텍스트 파일
 * - 메모장과 같은 단순 텍스트 편집기로 편집할 수 있는 파일
 * - 문자 집합에 따라 인코딩된 바이트 데이터이다.
...
public class Test2_0 {
	public static void main(String[] args) throws Exception {
		 ...
		 * 그러나 실제로 읽는 것은 4바이트 int의 끝 1바이트이다.
		 * 나머지 앞의 3바이트는 읽지 않고 버린다.
		 */
