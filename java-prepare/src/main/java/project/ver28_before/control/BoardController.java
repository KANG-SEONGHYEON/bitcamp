package project.ver28_before.control;

import java.sql.Date;
import java.util.Iterator;

import project.ver28_before.domain.Board;
import project.ver28_before.util.Prompts;
...
public class BoardController extends GenericController<Board> {
	...
	private void doUpdate() {
    	...
    	String content = Prompts.inputString("내용? ", board.getContent());
