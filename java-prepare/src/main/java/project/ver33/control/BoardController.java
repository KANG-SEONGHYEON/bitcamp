...
import project.ver33.domain.Board;
import project.ver33.util.Prompts;
...
public class BoardController extends GenericController<Board> {
    ...
    public void execute(Request request, Response response) {
            ...
            case "list": this.doList(request, response); break;
            case "add": this.doAdd(request, response); break;
            case "view": this.doView(request, response); break;
            case "update": this.doUpdate(request, response); break;
            case "delete": this.doDelete(request, response); break;
            default: 
