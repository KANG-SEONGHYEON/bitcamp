...
public class Score3 implements Serializable {
	 ...
	 *    다르다면 예외를 발생시킴으로서 데이터를 잘못 읽는 것을 방지한다.
	 *    
	 * => 클래스를 바꾼 후 serialize한 데이터를 바꾸기 전 클래스로
	 *    읽을 수 있게 하려면 serialVersionUID 변수의 값을 일치시키면 된다.
	 */
