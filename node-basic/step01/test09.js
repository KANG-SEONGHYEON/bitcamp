 ...
 * 이렇게 변수의 타입이 고정되는 것을 "static type binging"이라 부른다.
 * 
 * 물론 다음과 같이 같은 이름의 변수를 다른 타입으로 선얼 할 수 없다.
 * String a = "홍길동"; // 오류! 같은 이름의 변수를 또 선언할 수 없다.
 */

// 자바 스크립트는 다음과 같이 같은 이름으로 변수를 또 선언할 수 있다.
var v1 = 100
var v1 = 200
console.log(v1) 
 ...
 * 
 * 자바 스크립트의 변수는 자바 맵 객체에 값을 저장하는 것 처럼 다뤄진다.
